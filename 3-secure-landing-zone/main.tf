...
module "nonprod_host_project" {
  ...
  apis                      = var.apis
  folder_id                 = module.shared_services_sub_folders.folders_map["prj-paradigm-ss-nonprod"].id
...
module "prod_host_project" {
  ...
  apis                      = var.apis
  folder_id                 = module.shared_services_sub_folders.folders_map["prj-paradigm-ss-prod"].id
  billing_account           = var.billing_account
